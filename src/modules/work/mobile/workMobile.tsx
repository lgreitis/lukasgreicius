  ...
  return (
    <React.Fragment>
      ...
      {selectedItem && (
        ...
        >
          <Drawer.Portal>
            <Drawer.Content className="fixed bottom-0 left-0 right-0 mt-24 flex  max-h-[96%] flex-col rounded-t-[10px] bg-black">
              <img
              ...
              <div
                className={cn(
                  "prose prose-invert max-w-none overflow-auto rounded-b-3xl bg-black px-6",
